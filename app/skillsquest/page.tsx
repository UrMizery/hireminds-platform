...
description:
"Welcome, course expectations, HireMinds navigation, and pre-assessment.",
...
description:
"Explore CHW, DSP, home care, patient access, and entry-level healthcare pathways.",
sessionPlan: "2-hour instructor-led session.",
},
{
week: "Week 1",
...
description:
"Patient-centered care, communication, professionalism, and service expectations.",
sessionPlan: "2-hour instructor-led session.",
},
{
week: "Week 2",
...
description:
"Active listening, de-escalation, empathy, and documenting service interactions.",
...
description:
"Safety protocols, patient rights, privacy, dignity, autonomy, and interdisciplinary care team roles.",
sessionPlan:
...
description:
"Practice greeting a patient, verifying identity, confirming appointment details, and maintaining professionalism.",
status: "Coming Soon",
},
{
title: "Upset Patient De-escalation",
description:
"Practice responding to a frustrated patient using active listening, empathy, and calm communication.",
status: "Coming Soon",
},
{
title: "HIPAA Privacy Scenario",
description:
"Practice deciding what information can and cannot be shared in common healthcare office situations.",
status: "Coming Soon",
},
{
title: "Healthcare Job Search Simulation",
description:
"Practice reading job descriptions, identifying qualifications, and choosing which roles to apply for.",
status: "Coming Soon",
},
];
...
self-paced SkillsQuest modules, simulations, assessments,
...
<div style={styles.hourCard}>
<h3>22 Hours</h3>
<p>Asynchronous HireMinds learning</p>
</div>
...
<section style={styles.asyncBox}>
<p style={styles.programLabel}>Asynchronous Learning</p>
<h2 style={styles.sectionHeading}>What Participants Complete on HireMinds</h2>
<p style={styles.programText}>
Participants use SkillsQuest outside of live training hours to review
recorded sessions, complete timed study modules, practice workplace
scenarios, complete assessments, use career tools, and access
downloadable job aids.
</p>

<div style={styles.asyncList}>
<span>Timed study modules</span>
<span>Recorded session review</span>
<span>Simulations</span>
<span>Knowledge checks</span>
<span>Resume and interview tools</span>
<span>Certificates and badges</span>
</div>
</section>

<section style={styles.simulationBox}>
<p style={styles.programLabel}>Simulation Lab</p>
<h2 style={styles.sectionHeading}>Healthcare Practice Scenarios</h2>

<div style={styles.simGrid}>
{simulations.map((sim) => (
<div key={sim.title} style={styles.simCard}>
<h3>{sim.title}</h3>
<p>{sim.description}</p>
<span style={styles.lockedButton}>{sim.status}</span>
</div>
))}
</div>
</section>
