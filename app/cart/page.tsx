...
const starterItems: CartItem[] = [
  ...
  },
  {
    ...
    price: 39.99,
    descriptionEn: "Advanced package with CV tools, AI features, and more included support.",
    descriptionEs: "Paquete avanzado con herramientas de CV, funciones de IA y más soporte incluido.",
    descriptionAr: "باقة متقدمة تتضمن أدوات CV وميزات الذكاء الاصطناعي ودعمًا إضافيًا.",
    descriptionPl: "Zaawansowany pakiet z narzędziami CV, funkcjami AI i większym wsparciem.",
  },
  {
    ...
    price: 14.99,
    descriptionEn: "Practice with AI-guided interview support.",
    descriptionEs: "Practica con apoyo de entrevista guiado por IA.",
    descriptionAr: "تدرّب مع دعم مقابلة موجّه بالذكاء الاصطناعي.",
    descriptionPl: "Ćwicz z pomocą rozmowy prowadzonej przez AI.",
  },
  {
