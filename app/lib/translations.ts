...
> = {
  ...
  ar: {
    ...
    subtitle:
      "استعد، تحقق، واحصل على وظيفة. تساعد HireMinds المرشحين على عرض جاهزيتهم بما يتجاوز السيرة الذاتية التقليدية.",
    language: "اللغة",
    schedule: "حجز 1:1",
    jobBoard: "الوظائف",
    employerPartnerSignIn: "دخول صاحب العمل / الشريك",
    whoIs: "من هي HireMinds؟",
    whatWeDo: "ماذا نفعل",
    whatNext: "ما الخطوة التالية",
    whoIsText:
      "HireMinds منصة للقوى العاملة تساعد المرشحين على عرض مهاراتهم وجاهزيتهم وهويتهم المهنية بصورة أقوى.",
    whatWeDoText:
      "نجمع بين Career Passports والسير الذاتية وخيارات التحقق والمقابلات التجريبية وخدمات الدعم المهني في منصة واحدة.",
    whatNextText:
      "أنشئ Career Passport الخاص بك، وأكمل ملفك الشخصي، وابنِ سيرتك الذاتية، وافتح خدمات الدعم عند الحاجة.",
    careerCoach: "مدرب مهني",
    liveMockInterview: "مقابلة تجريبية مباشرة",
    liveResumeRevision: "مراجعة سيرة ذاتية مباشرة",
