...
const DRAFT_KEY = "hireminds_job_log_draft";
...
export default function JobLogGeneratorPage() {
  ...
  // EXACTLY 5 JOB ENTRIES
  const [entries, setEntries] = useState<JobLogItem[]>(
    Array.from({ length: 5 }, () => createEmptyLog())
  );
  ...
  useEffect(() => {
    try {
      ...
      if (Array.isArray(draft.entries)) {
        const restoredEntries = Array.from({ length: 5 }, (_, index) => {
          const existing = draft.entries[index];
      ...
      console.error("Could not load Job Log draft:", error);
    }
  }, []);

  /*
    ONLY FILLED ENTRIES FOR PREVIEW / PRINT
  */
  ...
  */
  ...
  function handleSaveDraft() {
    try {
      ...
      setMessage(
        "✓ Draft saved. You can leave this page and return to continue your Job Log."
      );
    } catch (error) {
  ...
  */
  ...
  function handleClearDraft() {
    const confirmed = window.confirm(
      "Clear this Job Log and delete the saved draft?"
    );
      ...
      <div style={styles.shell}>
        ...
        <section style={styles.heroCard}>
          <div style={styles.heroTop}>
            <div>
              ...
              <p style={styles.subtitle}>
                Track up to five job opportunities each week. Record
                applications, follow-ups, employer contacts, outcomes,
                research notes, and highlight the opportunities you
          ...
          <div style={styles.draftRow}>
            <div>
              <strong style={styles.draftLabel}>
                Draft Status
              </strong>
        ...
        <section style={styles.entriesSection}>
          <div style={styles.sectionHeader}>
            ...
            <p style={styles.sectionDescription}>
              Select the star on an opportunity you especially want
              to pursue. You can highlight more than one job.
            </p>
          </div>
          ...
          <div style={styles.previewCard}>
            <div style={styles.sheetWrap}>
              ...
              <p style={styles.starNote}>
                ★ Priority Opportunity — a position the participant
                especially wants to pursue.
              </p>
            </div>
          </div>
        </section>
        ...
        <div
          ref={printRef}
          style={styles.hiddenPrintWrap}
        >
          <div className="sheetHeader">
            <h1 className="sheetTitle">
              JOB APPLICATION RECORD
            </h1>
          </div>
    ...
    >
      ...
      <div style={styles.formGrid}>
        <Field
          ...
          value={entry.company}
          onChange={(value) =>
            updateEntry(index, "company", value)
          }
        ...
        <Field
          ...
          onChange={(value) =>
            updateEntry(index, "jobTitle", value)
          }
        ...
        <Field
          ...
          onChange={(value) =>
            updateEntry(index, "contactName", value)
          }
        ...
        <Field
          ...
          onChange={(value) =>
            updateEntry(index, "contactPhone", value)
          }
        ...
        <Field
          ...
          value={entry.outcome}
          onChange={(value) =>
            updateEntry(index, "outcome", value)
          }
...
const styles: Record<string, React.CSSProperties> = {
  ...
  priorityEntryCard: {
    ...
    boxShadow:
      "0 22px 60px rgba(0,0,0,0.26), 0 0 28px rgba(250,204,21,0.07)",
  },
