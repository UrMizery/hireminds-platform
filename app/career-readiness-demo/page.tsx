...
const modules = [
  {
    ...
    completionKey: "twp_career_readiness_module_1_complete",
  },
  {
    ...
    completionKey: "twp_career_readiness_module_2_complete",
  },
  {
    ...
    completionKey: "twp_career_readiness_module_3_complete",
  },
];
    ...
    <main style={styles.main}>
      <section style={styles.card}>
        ...
        <p style={styles.subtitle}>
          ...
          multiple 30-second demo study guides, activities, scenarios, and a
          module assessment. After all three modules are complete, the final
          Career Readiness assessment unlocks.
        </p>
