  ...
  useEffect(() => {
    async function checkAccess() {
      ...
      if (partnerResult.error) {
        console.error(
          "Independent Learning Lab partner access check failed:",
          partnerResult.error
        );
      }
      ...
      if (candidateResult.error) {
        console.error(
          "Independent Learning Lab candidate access check failed:",
