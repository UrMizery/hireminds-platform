  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      if (
        ...
        const cleanedSlots = profile.resume_slots.map(
      ...
      <div style={st.shell}>
        ...
        <section style={st.hero}>
          ...
          >
            ...
            >
              Update your profile,
              manage your resumes,
              and share your Career
              Passport with employers.
            </p>
          </div>
        ...
        >
          ...
          >
            Your photo,
            headline, location,
            LinkedIn, and selected
            resume appear on your
            Career Passport once
            completed.
          </p>
        </section>

        {/* KEEP CONNECT / CAREER CONNECT AREA */}
